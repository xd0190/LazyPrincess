...
async def doc(bot, update):
    ...
    try:
        ...
        if metadata.has("300"):
           duration = metadata.get('300').seconds
    except:
        pass
    ...
    await ms.edit("三 𝘗𝘳𝘦𝘱𝘢𝘳𝘪𝘯𝘨 𝘵𝘰 𝘳𝘦𝘤𝘦𝘪𝘷𝘦 NAWAB 𝘧𝘪𝘭𝘦...︻デ═一")
    c_time = time.time() 
    try:
       if type == "document":
          await bot.send_document(
	        update.message.chat.id,
                   ...
                   caption=caption, 
                   progress=progress_for_pyrogram,
                   progress_args=( "**⎝⎝✧ ʀᴇᴄɪᴇᴠɪɴɢ ꜰɪʟᴇ ꜰʀᴏᴍ NAWAB ꜱᴇʀᴠᴇʀ ✧⎠⎠**",  ms, c_time))
       elif type == "video": 
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @nawab_me♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank nawab_me ♥️')
            ...
            return await query.answer('♥️ Thank You nawab_me♥️')
        ...
        return await query.answer('♥️ Thank You NAWAB DEVELOPERS ♥️')
        ...
        return await query.answer('♥️ Thank You BAWAB Developer ♥️')
        ...
        return await query.answer('♥️ Thank You Nawab Developer ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/nawabbotupdate')
        ], [
        ...
        await query.answer('♥️ Thank You Nawab Developer ♥️')
        ...
        try:
            btn = [[
                InlineKeyboardButton(text=f"🔍 Search Here 🔎", url=f"https://telegram.me/nawab_me0")
            ],[
                InlineKeyboardButton(text=f"🐞 REPORT ISSUE 🐞", url=f"https://telegram.me/nawabbotupdate")
            ],[
    ...
    #             await client.send_message(MOVIE_GROUP_ID, text=extracted_line.group(1))
        ...
        if str(grp_id) != str(grpid):
            ...
            return await query.answer('♥️ Thank You NawabDeveloper ♥️')
